define('add-book',["exports", "aurelia-framework"], function (exports, _aureliaFramework) {
  "use strict";
...
define('app',['exports'], function (exports) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'home'], name: 'home', moduleId: 'index' }, { route: 'books', name: 'books', moduleId: 'books' }]);
    };

    return App;
  }();
});
define('book-api',['exports', 'aurelia-fetch-client', 'aurelia-framework'], function (exports, _aureliaFetchClient, _aureliaFramework) {
  'use strict';
...
define('book-list',['exports', 'aurelia-framework', 'book-api'], function (exports, _aureliaFramework, _bookApi) {
  'use strict';
...
define('books',["exports"], function (exports) {
  "use strict";
...
define('resources/elements/book-list',['exports', 'aurelia-framework', 'book-api'], function (exports, _aureliaFramework, _bookApi) {
  'use strict';
...
define('text!add-book.html', ['module'], function(module) { module.exports = "<template><form submit.trigger=\"addBook()\"><label for=\"book-title\"></label><input value.bind=\"bookTitle\" id=\"book-title\" type=\"text\" placeholder=\"book title...\"> <input type=\"submit\"></form></template>"; });
define('text!app.html', ['module'], function(module) { module.exports = "<template><router-view></router-view></template>"; });
define('text!book-list.html', ['module'], function(module) { module.exports = "<template><ul><li repeat.for=\"book of books\">${book.title}</li></ul></template>"; });
define('text!books.html', ['module'], function(module) { module.exports = "<template><require from=\"add-book\"></require><require from=\"book-list\"></require><h1>Books</h1><add-book books.bind=\"books\"></add-book><hr><book-list books.bind=\"books\"></book-list></template>"; });
...
define('text!resources/elements/add-book.html', ['module'], function(module) { module.exports = "<template><form submit.trigger=\"addBook()\"><label for=\"book-title\"></label><input value.bind=\"bookTitle\" id=\"book-title\" type=\"text\" placeholder=\"book title...\"> <input type=\"submit\"></form></template>"; });
