...
define('resources/elements/add-book',["exports", "aurelia-framework"], function (exports, _aureliaFramework) {
  ...
  var AddBook = exports.AddBook = (_dec = (0, _aureliaFramework.computedFrom)('bookTitle.length'), (_class = function () {
    function AddBook() {
...
define('resources/elements/book-list',['exports', 'aurelia-framework', '../../services/book-api'], function (exports, _aureliaFramework, _bookApi) {
  ...
  var BookList = exports.BookList = (_dec = (0, _aureliaFramework.inject)(_bookApi.BookApi), _dec(_class = (_class2 = function () {
    function BookList(bookApi) {
    ...
    BookList.prototype.created = function created() {
      var _this = this;
...
define('text!resources/elements/book.html', ['module'], function(module) { module.exports = "<template><require from=\"./edit-book\"></require><div class=\"book col-12\"><div class=\"book-options form-inline\"><div class=\"col-lg-7 col-md-3\">${book.title}</div><div class=\"col-lg-3 col-md-5\"><button class=\"read-button btn btn-success btn-sm\" if.bind=\"!book.readDate\" click.delegate=\"markRead(event)\"><span class=\"hover-display\"><i class=\"fa fa-check\" aria-hidden=\"true\"></i> </span>mark read</button> <button class=\"btn btn-secondary btn-sm edit-button\" click.delegate=\"toggleEditMode()\" disabled.bind=\"editMode\">edit</button></div><div class=\"col-1\"><span class=\"remove-button\" click.delegate=\"removeBook($index)\"><i class=\"fa fa-trash\" aria-hidden=\"true\"></i></span></div></div><edit-book book.bind=\"book\" containerless edit-mode.bind=\"editMode\"></edit-book></div></template>"; });
define('text!resources/elements/books.html', ['module'], function(module) { module.exports = "<template><require from=\"./add-book\"></require><require from=\"./book-list\"></require><require from=\"./heading.html\"></require><heading text.bind=\"'books'\"></heading><add-book books.bind=\"books\"></add-book><hr><book-list books.bind=\"books\"></book-list></template>"; });
